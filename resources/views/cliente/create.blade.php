...
<body>
    ...
    <div class="d-flex justify-content-center align-items-center flex-column" style="height: calc(100vh - 56px);">
        ...
        <form id="formulario" name="formulario" class="w-25" action="{{route('cliente.store')}}" method="POST">
            @csrf
           
            <div class="form-floating mb-3">
                <input name="telefono" type="text" class="form-control" id="telefono" placeholder="Numero de teléfono">
                <label for="telefono">Número de teléfono</label>
            </div>
            <div class="form-floating mb-3">
                <input name="num_social" type="date" class="form-control" id="num_social" placeholder="Número social">
